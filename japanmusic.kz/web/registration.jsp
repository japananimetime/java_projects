                                    ...
                                    <tr>                                        
                                        <td id="registerForm">                                                                                      
                                            <form action ="register" method='post'>
                                                <label for="Login">Your login</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;    <input type="text" name ="Login"><br><br>
                                                <label for="Pass"> Your password</label>&nbsp;<input type="password" name="Pass"><br><br>
                                                <label for="Mail"> Your mail</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;     <input type="text" name="Mail"><br><br>
