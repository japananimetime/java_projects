            ...
            <tr>
                <td colspan="3" align="center">
                    <%  if (request.getSession(false).getAttribute("login")==null){ 
                            ...
                            out.println("<h3>Edit your tweet in the textarea or remove it with the help of the button below</h3><br>");
                            out.println("<form action='edit' method='post'><input type='text' value='"+request.getParameter("tCO")+"'  name='newText'><input type='hidden' value='"+request.getParameter("tID")+"' name='tID'>"+"<br><input type='submit' value='Change'></form>");
                            out.println("<form action='remove' method='post'><br><input type='hidden' value='"+request.getParameter("tID")+"' name='tID'>"+"<input type='submit' value='Remove'></form>");                        }
                    %>                    
                </td>
            </tr>
            <tr>
